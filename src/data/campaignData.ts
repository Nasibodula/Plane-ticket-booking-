...
export const campaigns: CampaignItem[] = [
  {
    id: 1,
    title: "Autumn Travel Specials",
    description:
      "Get up to 30% off on autumn flights to selected destinations.",
  ...
  },
  {
    ...
    description: "Special weekend packages available for top cities in Europe.",
  ...
  },
  {
    ...
    description: "Book your 2024 flights now and save up to 40%.",
  ...
  },
  {
    ...
    description:
      "Enjoy discounted fares for holiday seasons to over 100 destinations.",
    imageUrl: "/img/campaign/2.jpg",
    url: "#",
  },
  {
    ...
    description:
      "Exclusive offers for students, with up to 25% off on tickets.",
    imageUrl: "/img/campaign/3.jpg",
    url: "#",
  },
  {
    ...
    title: "Luxury Escape",
    description:
      "Luxury travel packages with all-inclusive benefits at special rates.",
    imageUrl: "/img/campaign/1.jpg",
    url: "#",
  },
  {
